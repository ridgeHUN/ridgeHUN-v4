...
LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        ...
        QueueOnTeleport(Parvus.Debug and readfile("Parvus/Loader.lua") or game:HttpGetAsync("https://raw.githubusercontent.com/ridgeHUN/ridgeHUN-v4/main/Main.lua"))
    end
end)
...
if SupportedGame then
    ...
    loadstring(Parvus.Debug and readfile("Parvus/Universal.lua") or game:HttpGetAsync("https://raw.githubusercontent.com/ridgeHUN/ridgeHUN-v4/main/Main.lua"))()
    Parvus.Utilities.UI:Notification({
        Title = "ridgeHUN",
        Description = Parvus.Current .. " loaded!",
        Duration = 5
